...
export default function Experience({
  ...
  return (
    <a href={link} target="_blank" rel="noopener noreferrer">
      <div className="group lg:flex lg:justify-between py-4 lg:px-2 rounded-md hover:shadow-lg transition duration-300 cursor-pointer hover:bg-slate-800/50 cursor-pointe">
