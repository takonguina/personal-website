...
export default function Experience({
  ...
  return (
    <a href={link} target="_blank" rel="noopener noreferrer">
      <div className="group lg:flex lg:justify-between lg:py-4 lg:px-4 rounded-md lg:hover:shadow-lg transition duration-300 cursor-pointer lg:hover:bg-slate-800/50">
